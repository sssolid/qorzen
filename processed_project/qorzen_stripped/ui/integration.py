...
class UIIntegration(abc.ABC):
    ...
    def add_menu(self, plugin_id: str, title: str, parent_menu: Optional[Union[str, QMenu]]=None) -> QMenu:
        ...
    @abc.abstractmethod
    def add_menu_action(self, plugin_id: str, menu: Union[str, QMenu], text: str, callback: Callable[[], None], icon: Optional[QIcon]=None) -> QAction:
        ...
    @abc.abstractmethod
    def add_toolbar(self, plugin_id: str, title: str) -> QToolBar:
        ...
    @abc.abstractmethod
    def add_toolbar_action(self, plugin_id: str, toolbar: QToolBar, text: str, callback: Callable[[], None], icon: Optional[QIcon]=None) -> QAction:
        ...
    @abc.abstractmethod
    def add_dock_widget(self, plugin_id: str, dock: Union[DockComponent, QWidget], title: str, area: str='right') -> QDockWidget:
        ...
    @abc.abstractmethod
    def add_page(self, plugin_id: str, widget: QWidget, name: str, icon: QIcon, text: str, group: Optional[str]=None) -> int:
        ...
    @abc.abstractmethod
...
class MainWindowIntegration(UIIntegration):
    ...
    def remove_page(self, plugin_id: str, name: str) -> None:
        if not hasattr(self.main_window, 'panel_layout'):
            return
        self.main_window.panel_layout.select_page('dashboard')
