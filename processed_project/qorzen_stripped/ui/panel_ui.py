...
class Sidebar(QFrame):
    ...
    def add_button(self, icon: QIcon, text: str, page_index: int, group: Optional[str]=None, checkable: bool=True) -> SidebarButton:
...
class MainWindow(QMainWindow):
    ...
    def _subscribe_to_events(self) -> None:
        if not self._event_bus:
            return
        self._event_bus.subscribe(event_type='plugin/loaded', callback=self._on_plugin_loaded_event, subscriber_id='ui_plugin_loaded')
        self._event_bus.subscribe(event_type='plugin/unloaded', callback=self._on_plugin_unloaded_event, subscriber_id='ui_plugin_unloaded')
    ...
    def _on_plugin_state_change(self, plugin_name: str, enable: bool) -> None:
        ...
        try:
            ...
            self._logger.error(f'Error changing plugin state: {str(e)}', extra={'plugin_name': plugin_name, 'enable': enable})
    def _on_plugin_reload(self, plugin_name: str) -> None:
        ...
        try:
            ...
            self._logger.error(f'Error reloading plugin: {str(e)}', extra={'plugin_name': plugin_name})
    ...
    def _add_plugin_ui_components(self, plugin_name: str, instance: Any) -> None:
        ...
        try:
            ...
            self._logger.error(f'Error adding UI components for plugin {plugin_name}: {str(e)}', extra={'plugin_name': plugin_name})
