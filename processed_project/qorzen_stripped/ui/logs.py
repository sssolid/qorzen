...
class LogsView(QWidget):
    def __init__(self, event_bus: Any, parent: Optional[QWidget]=None) -> None:
        super().__init__(parent)
    ...
    def _subscribe_to_log_events(self) -> None:
        if not self._event_bus:
            return
        self._log_subscription_id = self._event_bus.subscribe(event_type='log/event', callback=self._on_log_event, subscriber_id='logs_view')
