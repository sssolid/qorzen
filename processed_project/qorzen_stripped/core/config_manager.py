...
class ConfigSchema(BaseModel):
    database: Dict[str, Any] = Field(default_factory=lambda: {'type': 'sqlite', 'host': 'localhost', 'port': 5432, 'name': 'qorzen', 'user': 'username', 'password': '', 'pool_size': 5, 'max_overflow': 10, 'echo': False}, description='Database connection settings')
