...
class FieldMapping(BaseModel):
    ...
    created_at: datetime.datetime = Field(default_factory=datetime.datetime.now, description='When this mapping was created')
    updated_at: datetime.datetime = Field(default_factory=datetime.datetime.now, description='When this mapping was last updated')
    class Config:
        validate_assignment = True
class SavedQuery(BaseModel):
    ...
    created_at: datetime.datetime = Field(default_factory=datetime.datetime.now, description='When this query was created')
    updated_at: datetime.datetime = Field(default_factory=datetime.datetime.now, description='When this query was last updated')
...
class QueryHistoryEntry(BaseModel):
    ...
    executed_at: datetime.datetime = Field(default_factory=datetime.datetime.now, description='When this query was executed')
...
class ValidationRule(BaseModel):
    ...
    created_at: datetime.datetime = Field(default_factory=datetime.datetime.now, description='When this rule was created')
    updated_at: datetime.datetime = Field(default_factory=datetime.datetime.now, description='When this rule was last updated')
    class Config:
        validate_assignment = True
class ValidationResult(BaseModel):
    id: str = Field(default_factory=lambda: str(uuid.uuid4()), description='Unique identifier for this validation result')
    rule_id: str = Field(..., description='ID of the validation rule')
    table_name: str = Field(..., description='Database table name')
    field_name: str = Field(..., description='Field that was validated')
    validated_at: datetime.datetime = Field(default_factory=datetime.datetime.now, description='When validation was performed')
...
class HistorySchedule(BaseModel):
    ...
    created_at: datetime.datetime = Field(default_factory=datetime.datetime.now, description='When this schedule was created')
    updated_at: datetime.datetime = Field(default_factory=datetime.datetime.now, description='When this schedule was last updated')
    class Config:
        validate_assignment = True
class HistoryEntry(BaseModel):
    ...
    collected_at: datetime.datetime = Field(default_factory=datetime.datetime.now, description='When data was collected')
