...
class AS400Tab(QWidget):
    ...
    def __init__(self, event_bus_manager: Any, logger: Any, config: Any, file_manager: Any=None, thread_manager: Any=None, security_manager: Any=None, parent: Optional[QWidget]=None) -> None:
