"""Command-line interface for the Qorzen build system.

This module provides a command-line interface for building and packaging
the Qorzen application.
"""
...
def parse_args(args: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Build and package the Qorzen application",
    ...
    parser.add_argument(
        ...
        type=str,
        default="Qorzen",
        help="Name of the application (used for output filenames)",
    )

    parser.add_argument(
        "--version",
        type=str,
        default=get_application_version(),
        help="Version string for the application",
    )
    ...
    parser.add_argument(
        ...
        default=BuildPlatform.CURRENT.value,
    ...
    parser.add_argument(
        "--build-type",
        type=str,
        choices=[t.value for t in BuildType],
        default=BuildType.ONEDIR.value,
    ...
    parser.add_argument(
        "--console",
        action="store_true",
        help="Include a console window",
    )

    parser.add_argument(
        "--icon",
        type=str,
        help="Path to the application icon file",
    )

    parser.add_argument(
        "--entry-point",
        type=str,
        default="qorzen/main.py",
        help="Main entry point script for the application",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="dist",
        help="Directory where build artifacts will be placed",
    )
    ...
    parser.add_argument(
        ...
        action="append",
        default=[],
        help="Additional path to include in the build (can be specified multiple times)",
    )
    ...
    parser.add_argument(
        ...
        action="append",
        default=[],
        help="Path to exclude from the build (can be specified multiple times)",
    )
    ...
    parser.add_argument(
        ...
        action="append",
        default=[],
        help="Python module to include that may not be detected (can be specified multiple times)",
    )
...
def create_config_from_args(args: argparse.Namespace) -> BuildConfig:
    ...
    """
    # If a config file was specified, load it first
    if args.config:
...
def main(args: Optional[List[str]] = None) -> int:
    ...
    # Create logger
    if args.verbose:
        # More detailed logger for verbose mode
        def logger(message: str) -> None:
            print(message)
    else:
        # Simple progress logger for normal mode
        def logger(message: str) -> None:
    ...
    try:
        ...
        if args.create_installer:
            ...
            try:
                ...
                # Continue anyway, as the build itself was successful
