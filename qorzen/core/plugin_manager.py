...
class PluginManager(QorzenManager):
    ...
    def __init__(
        ...
        # Set thread manager on lifecycle manager
    ...
    def load_plugin(self, plugin_name: str) -> bool:
        ...
        try:
            ...
            # Set plugin to initializing state
