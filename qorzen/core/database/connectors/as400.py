...
class AS400Connector(BaseDatabaseConnector):
    ...
    def __init__(self, config: Any, logger: Any, security_manager: Optional[Any] = None) -> None:
        ...
        Raises:
            ImportError: If JPype is not installed
        """
    ...
    def _initialize_jpype(self) -> None:
        """Initialize the JVM with JT400 JAR file.

        Raises:
            Exception: If JVM initialization fails
        """
        jpype = self._jpype
    ...
    async def _connect_with_database_manager(self) -> None:
        """Connect using the database manager.
    ...
    async def execute_query(
        ...
        try:
            ...
            sanitized_query = self._sanitize_sql_for_logging(query)
            self._logger.debug(
                "Executing AS400 query directly",
    ...
    async def _get_tables_direct(self, schema: Optional[str] = None) -> List[Dict[str, Any]]:
        """Get tables directly using JPype.
    ...
    async def _get_table_columns_direct(
        ...
        """Get table columns directly using JPype.
    ...
    def _validate_and_prepare_query(
        ...
        Returns:
            Optional[str]: The extracted table name
    ...
    def _set_prepared_statement_parameter(
        ...
        Args:
            ...
            java_sql_Types: The java.sql.Types class
        """
        jpype = self._jpype
    ...
    def _process_result_set(
        ...
        Args:
            result_set: The JDBC result set
            java_sql_Types: The java.sql.Types class

        Returns:
            Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]: Records and columns
        """
