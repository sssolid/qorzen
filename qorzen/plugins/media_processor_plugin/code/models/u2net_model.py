...
class ConvBNReLU(nn.Module):
    ...
    def __init__(self, in_ch: int, out_ch: int, kernel_size: int = 3, dilation: int = 1) -> None:
        ...
        self.conv = nn.Conv2d(
            in_ch, out_ch, kernel_size=kernel_size, padding=padding, dilation=dilation, bias=False
        )
...
class REBNCONV(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            dilation: Dilation rate
            stride: Stride
            padding: Padding (calculated if None)
        """
...
class U2NET(nn.Module):
    ...
    def __init__(self, in_ch: int = 3, out_ch: int = 1) -> None:
        ...
        Args:
            in_ch: Input channels (3 for RGB images)
