...
class DatabaseConnectorPlugin(BasePlugin):
    ...
    async def initialize(self, application_core: Any, **kwargs: Any) -> None:
        ...
        # Get required managers from application core
        ...
        # Initialize history manager if history database is configured
    ...
    async def on_ui_ready(self, ui_integration: Any) -> None:
        ...
        # If not on main thread, delegate to main thread
        ...
        try:
            ...
            # Create and register main widget if not already created
    ...
    async def save_connection(self, config: BaseConnectionConfig) -> str:
        try:
            ...
            raise PluginError(f'Failed to save connection: {str(e)}') from e
    ...
    async def delete_connection(self, connection_id: str) -> bool:
        try:
            ...
            raise PluginError(f'Failed to delete connection: {str(e)}') from e
    ...
    async def get_connector(self, connection_id: str) -> BaseDatabaseConnector:
        try:
            ...
            raise PluginError(f'Failed to get connector: {str(e)}') from e
    ...
    async def disconnect(self, connection_id: str) -> bool:
        try:
            ...
            raise PluginError(f'Failed to disconnect: {str(e)}') from e
    ...
    async def get_saved_queries(self, connection_id: Optional[str] = None) -> Dict[str, SavedQuery]:
        if connection_id:
            return {qid: query for qid, query in self._saved_queries.items()
    ...
    async def save_query(self, query: SavedQuery) -> str:
        try:
            ...
            raise PluginError(f'Failed to save query: {str(e)}') from e
    ...
    async def execute_query(
        ...
        try:
            ...
            raise PluginError(f'Failed to execute query: {str(e)}') from e
    ...
    async def save_field_mapping(self, mapping: FieldMapping) -> str:
        try:
            ...
            raise PluginError(f'Failed to save field mapping: {str(e)}') from e
    ...
    async def delete_field_mapping(self, mapping_id: str) -> bool:
        try:
            ...
            raise PluginError(f'Failed to delete field mapping: {str(e)}') from e
    ...
    async def _save_settings(self) -> None:
        try:
            ...
            raise PluginError(f'Failed to save settings: {str(e)}') from e
    ...
    async def _load_connections(self) -> None:
        try:
            ...
            raise PluginError(f'Failed to load connections: {str(e)}') from e
    ...
    async def _save_connections(self) -> None:
        try:
            ...
            raise PluginError(f'Failed to save connections: {str(e)}') from e
    ...
    async def _get_connector_direct(self, connection_id: str) -> BaseDatabaseConnector:
        try:
            ...
            raise PluginError(f'Failed to get connector directly: {str(e)}') from e
    ...
    async def _load_saved_queries(self) -> None:
        try:
            ...
            raise PluginError(f'Failed to load saved queries: {str(e)}') from e
    ...
    async def _save_saved_queries(self) -> None:
        try:
            ...
            raise PluginError(f'Failed to save queries: {str(e)}') from e
    ...
    async def _load_field_mappings(self) -> None:
        try:
            ...
            raise PluginError(f'Failed to load field mappings: {str(e)}') from e
    ...
    async def _save_field_mappings(self) -> None:
        try:
            ...
            raise PluginError(f'Failed to save field mappings: {str(e)}') from e
    ...
    async def shutdown(self) -> None:
        ...
        try:
            ...
            raise PluginError(f'Error during plugin shutdown: {str(e)}') from e
